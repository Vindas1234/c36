...
var feed,addFood;
var foodObj;
var washroomIMG,bedroomIMG,livingroomIMG;
var washroom, bedroom,livingroom;
...
washroom=createSprite(10,10);
washroom.addImage(washroomIMG);

bedroom=createSprite(10,10);
bedroom.addImage(bedroomIMG);

livingroom=createSprite(10,10);
